...
public class GuiManager {
    ...
    public void renderGui() {
        ...
        System.out.println("\n" + "=".repeat(60));
        System.out.println("§6NimbusWare §fv" + NimbusWare.VERSION);
        ...
        List<Module> modules = NimbusWare.INSTANCE.getModuleManager().getModulesByCategory(categories[selectedCategory]);
        ...
        // Render status info
        int enabledCount = NimbusWare.INSTANCE.getModuleManager().getEnabledModules().size();
